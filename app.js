...
const stripe = new Stripe(
  "sk_test_51P88OSP7whfjob9cFTeFZowSAubEgI0RCcKmVBXRBR47qTc5FpCiWyEEmkYeWZMd0I4COkP0TRd73jExA0D6ugNR004UJqZkWX"
);
...
const [premium, pass] = [
  "price_1P8MSkP7whfjob9ctsaaUvLP",
  "price_1P8MQsP7whfjob9c0tjTpE2Q",
];
  ...
  try {
    ...
    if (session.payment_status === "paid") {
      ...
      try {
        ...
        const planType =
          subscription.plan.amount === 100000 ? "premium" : "pass";
